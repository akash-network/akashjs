...
export const QueryLeasesRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryLeasesRequest>, I>>(base?: I): QueryLeasesRequest {
...
export const QueryLeasesResponse = {
  ...
  create<I extends Exact<DeepPartial<QueryLeasesResponse>, I>>(base?: I): QueryLeasesResponse {
...
export const QueryLeaseRequest = {
  ...
  create<I extends Exact<DeepPartial<QueryLeaseRequest>, I>>(base?: I): QueryLeaseRequest {
...
export const QueryLeaseResponse = {
  ...
  toJSON(message: QueryLeaseResponse): unknown {
    ...
    message.escrowPayment !== undefined &&
      (obj.escrowPayment = message.escrowPayment ? FractionalPayment.toJSON(message.escrowPayment) : undefined);
    return obj;
  },

  create<I extends Exact<DeepPartial<QueryLeaseResponse>, I>>(base?: I): QueryLeaseResponse {
...
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    this.service = opts?.service || "akash.market.v1beta3.Query";
    this.rpc = rpc;
