...
export const MsgCreateBid = {
  ...
  create<I extends Exact<DeepPartial<MsgCreateBid>, I>>(base?: I): MsgCreateBid {
...
export const MsgCloseBidResponse = {
  ...
  create<I extends Exact<DeepPartial<MsgCloseBidResponse>, I>>(base?: I): MsgCloseBidResponse {
