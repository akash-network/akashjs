...
export const QueryInterchainAccountFromAddressRequest = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryInterchainAccountFromAddressRequest>, I>>(object: I): QueryInterchainAccountFromAddressRequest {
    const message = createBaseQueryInterchainAccountFromAddressRequest();
...
messageTypeRegistry.set(QueryInterchainAccountFromAddressRequest.$type, QueryInterchainAccountFromAddressRequest);
...
export const QueryInterchainAccountFromAddressResponse = {
  ...
  fromPartial<I extends Exact<DeepPartial<QueryInterchainAccountFromAddressResponse>, I>>(object: I): QueryInterchainAccountFromAddressResponse {
    const message = createBaseQueryInterchainAccountFromAddressResponse();
...
messageTypeRegistry.set(QueryInterchainAccountFromAddressResponse.$type, QueryInterchainAccountFromAddressResponse);
